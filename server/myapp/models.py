...
class Thing(models.Model):
    ...
    park_number = models.CharField(max_length=30, blank=True, null=True)  # 车位号
    park_type = models.CharField(max_length=30, blank=True, null=True)  # 车位类型
    park_price = models.CharField(max_length=100, blank=True, null=True)  # 单价
    park_status = models.CharField(max_length=1, choices=STATUS_CHOICES, default='0')
    create_time = models.DateTimeField(auto_now_add=True, null=True)
...
class Wg(models.Model):
    id = models.BigAutoField(primary_key=True)
    car_number = models.CharField(max_length=30, blank=True, null=True) # 车牌号
    park_number = models.CharField(max_length=30, blank=True, null=True) # 车位号
    desc = models.CharField(max_length=30, blank=True, null=True) # 违规描述
    create_time = models.DateTimeField(auto_now_add=True, null=True)
